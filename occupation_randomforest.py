...
#forest = RandomForestClassifier(n_estimators=1500,random_state=0,n_jobs=-1,verbose=True,min_samples_leaf=100)
forest = SVC(verbose=True)
print 'training forest...'
forest.fit(X,y)
print 'training complete ...'
print 'saving...'
joblib.dump(forest,"occupation_SVC.pkl")
print 'Saved model as occupation_SVC.pkl ....'
